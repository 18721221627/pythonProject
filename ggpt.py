...
time.sleep(1)
# 访问登录页面
url = 'https://mobile.gghypt.net/platformapp/plpage/login.html?_dc=1614848957858&userId=427ea9c1-8b8a-4191-%E2%80%A6'
time.sleep(3)
# 设置界面最大化
...
print('验证码是',distance)
#输入账号
browser.find_element_by_id('username').send_keys('18001098773')
#输入密码

browser.find_element_by_id('userpass').send_keys('qweqweqwe1')
# 在输入框输入验证码
yzm_input = browser.find_element_by_xpath('//*[@id="imgcode"]')
yzm_input.send_keys(distance)
time.sleep(3)
#点击登录
browser.find_element_by_xpath('//*[@id="dologing"]').click()
